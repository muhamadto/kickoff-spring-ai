...
public class GenAiConfig {
	...
	private static ChatClient.Builder enrichChatClientBuilder(final ChatClient.Builder builder,
		...
		return builder
				.defaultAdvisors(new PiiRedactionAdvisor(10),
	...
	/**
	 * The pro model finally earns its keep: every earlier module wired it up "for the query-optimisation work coming later" and never actually called
	 * it. {@code Worldcup2026Service} uses this one for the final answer, after step-back retrieval has already run.
	 */
	@Bean
