...
public class TeamTool {
	...
	@Tool(name = "get-teams", description = "Get the list of teams competing in the World Cup 2026, optionally filtered by group")
	public List<String> getTeams(
			@ToolParam(description = "An optional group letter filter, e.g., 'A'. Pass empty string for all 48 teams.") String group) {
