...
public class FixtureTool {
	...
	@Tool(name = "get-fixtures", description = "Get the list of World Cup 2026 group-stage fixtures for a specific date or team")
	public List<Fixture> getFixtures(
			@ToolParam(description = "An optional date filter, e.g., '15 June 2026'. Pass empty string for all fixtures.") String date,

			@ToolParam(description = "An optional team filter, e.g., 'Morocco'. Pass empty string for all teams.") String team) {
