...
public class GenAiConfig {
	 ...
	 * from {@code 012-agentic-rag} onward. Retrieval was never the thing this module needed to guard; it stays a fixed advisor that runs on every
	 * general question, same as always, whichever advisor backs it.
	 */
	@Bean
